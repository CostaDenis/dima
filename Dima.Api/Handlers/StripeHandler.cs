...
public class StripeHandler : IStripeHandler
{
    public async Task<Response<string?>> CreateSessionAsync(CreateSessionRequest request)
    {
        var options = new SessionCreateOptions
        {
            ...
            //Qunado cria a sessão, ainda n tem o pagamento em si
            //apenas a intenção
            ...
            //como minha conta é de teste no stripe só tem a opção de cartão
            PaymentMethodTypes = [
                "card"
            ],
            LineItems = [
            ...
            CancelUrl = $"{Configuration.FrontendUrl}/pedidos/{request.OrderNumber}/canelar"
        };
